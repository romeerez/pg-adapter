...
var AdapterBase = /** @class */ (function () {
    function AdapterBase(_a) {
        ...
        this.sockets = new Array(pool).fill(null).map(function () {
            return new Socket({ readable: true, writable: true });
        });
...
var prepare = function (adapter, name) {
    ...
    return function (prepareTemplate, prepareArgs) {
        ...
        prepared.objects = function () {
            ...
            return prepared.performQuery(ResultMode.objects, args);
        };
        prepared.arrays = function () {
            ...
            return prepared.performQuery(ResultMode.arrays, args);
        };
        prepared.value = function () {
            ...
            return prepared.performQuery(ResultMode.value, args);
        };
        prepared.exec = function () {
            ...
            return prepared.performQuery(ResultMode.skip, args);
        };
...
export { Adapter, AdapterBase, ResultMode, Transaction, parseUrl, quote, sql };
